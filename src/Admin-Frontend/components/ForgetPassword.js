...
export default function ForgotPassword({ onBackToLogin }) {
  ...
  const resetPassword = async () => {
    try {
      ...
      if (response.data.success) {
        // Optionally show username + new password in toast (if returned)
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-navy-900 to-blue-900">
